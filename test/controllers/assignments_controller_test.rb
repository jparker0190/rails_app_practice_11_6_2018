...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { portfolio_id: @assignment.portfolio_id, stock_id: @assignment.stock_id } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { portfolio_id: @assignment.portfolio_id, stock_id: @assignment.stock_id } }
